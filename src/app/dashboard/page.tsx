          ...
          <div className="max-w-4xl">
            <div className="bg-white rounded-3xl p-8 mb-5 border-gray-800 border-1 shadow-md">
              ...
              <div className="grid grid-cols-2 gap-5">
                <Card title="Gérer les employés" linkTo="/dashboard/employees" />
                <Card title="Gérer les vacances" linkTo="/dashboard/vacations" />
                <Card title="Gérer les types de vacances" linkTo="/dashboard/vacation-types" />
